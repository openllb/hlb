...
class HlbLexer(RegexLexer):
    ...
    tokens = {
        'root' : [
            ...
            (u'(\\b[a-zA-Z_][a-zA-Z0-9_]*\\b)(\\()', bygroups(Name.Variable, Punctuation), 'params'),
            (u'(\\))', bygroups(Generic.Error)),
            (u'((?:[\\t ]+)binds(?:[\\t ]+))(\\()', bygroups(Keyword, Punctuation), 'params'),
            (u'(\\))', bygroups(Generic.Error)),
            (u'(\\{)', bygroups(Punctuation), 'block'),
            (u'(\\})', bygroups(Generic.Error)),
            (u'(\\b[a-zA-Z_][a-zA-Z0-9_]*\\b)', bygroups(Name.Variable)),
            ('(\n|\r|\r\n)', String),
            ('.', String),
        ], 
        'binding' : [
            (u'(\\b[a-zA-Z_][a-zA-Z0-9_]*\\b)((?:[\\t ]+))(\\b[a-zA-Z_][a-zA-Z0-9_]*\\b)', bygroups(Name.Builtin, Punctuation, Name.Variable)),
            ('(\n|\r|\r\n)', String),
            ('.', String),
        ], 
        'block' : [
            ...
            (u'(as)((?:[\\t ]+))(\\b[a-zA-Z_][a-zA-Z0-9_]*\\b)', bygroups(Keyword, Punctuation, Name.Variable)),
            (u'(binds)((?:[\\t ]+))(\\()', bygroups(Keyword, Punctuation, Punctuation), 'binding'),
            ...
            (u'(\\b[a-zA-Z_][a-zA-Z0-9_]*\\b)', bygroups(Name.Builtin)),
            ('(\n|\r|\r\n)', String),
            ('.', String),
        ], 
        'common__1' : [
