...
func TestDebuggerEarlyExit(t *testing.T) {
	t.Parallel()
	...
	testDebugger(t, input, func(t *testing.T, d Debugger, mod *ast.Module) {
		// Early exit.
		d.Terminate()
		s, err := d.GetState()
		require.Nil(t, s)
...
func TestDebuggerMovement(t *testing.T) {
	t.Parallel()
...
func TestDebuggerBacktrace(t *testing.T) {
	t.Parallel()
...
func TestDebuggerBreakpoint(t *testing.T) {
	...
	testDebugger(t, input, func(t *testing.T, d Debugger, mod *ast.Module) {
		...
		s, err = d.Continue(ForwardDirection)
		require.NoError(t, err)
		require.Equal(t, line8, s.Node)
		logState(t, s, "line8")
	})
}

func TestDebuggerSourceDefinedBreakpoint(t *testing.T) {
	t.Parallel()
...
func testDebugger(t *testing.T, input string, p procedure) {
	d := NewDebugger(nil)
